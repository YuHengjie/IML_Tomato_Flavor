...
# %% 
y_name = 'Flavor intensity' #  ['Overall liking', 'Sweetness', 'Sourness', 'Umami', 'Flavor intensity']
y = data.loc[:,y_name]
y
...
for feature in feature_name_list:
    ...
    ICE_lines_show = pd.read_csv("./PDP_ICE/ICE_{}_{}.zip".format(y_name,feature),index_col=0)
    PDP_lines_df = pd.read_csv("./PDP_ICE/PDP_{}_{}.zip".format(y_name,feature),index_col=0)
