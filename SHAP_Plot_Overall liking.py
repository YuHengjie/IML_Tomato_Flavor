...
# %%  
y_name = 'Overall liking' #  ['Overall liking', 'Sweetness', 'Sourness', 'Umami', 'Flavor intensity']
y = data.loc[:,y_name]
y
...
# %% 2 interactions
feature_1 = 'trans-3-hexen-1-ol'
feature_2 = '6-methyl-5-hepten-2-ol'
